...
export function AddOptionDialog({ open, onOpenChange, questionTitle, onAdd }: AddOptionDialogProps) {
  const handleSelectStandardOption = () => {
    const newOption: Option = {
      id: uuidv4(),
      title: "New Option",
      candidate_name: "New Option",
      short_description: "",
      candidate_bio: "",
      description: "",
    }
  ...
  const handleSelectWriteInOption = () => {
    const newOption: Option = {
      ...
      candidate_name: "Write-in Option",
      short_description: "Voters can type in a response to the question.",
      candidate_bio: "Voters can type in a response to the question.",
      description: "Voters can type in a response to the question.",
    }
    onAdd(newOption)
  }
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle className="bg-[#00a1ff] text-white p-4 -mx-6 -mt-6 text-xl font-normal">Add Option</DialogTitle>
        </DialogHeader>
        ...
        <div className="py-4">
          ...
          <div className="space-y-4">
            <div className="border rounded-md p-4 flex items-center justify-between hover:bg-gray-50 cursor-pointer">
              ...
              <Button className="bg-green-500 hover:bg-green-600" onClick={handleSelectStandardOption}>
                Select
              </Button>
            </div>
            ...
            <div className="border rounded-md p-4 flex items-center justify-between hover:bg-gray-50 cursor-pointer">
              ...
              <Button className="bg-green-500 hover:bg-green-600" onClick={handleSelectWriteInOption}>
                Select
              </Button>
            </div>
          </div>
